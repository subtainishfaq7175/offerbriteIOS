...
//  MasterChefPK
//
//  Created by Ahsan Hameed on 10/4/16.
...
class Reachability: NSObject  {
   ...
   public static func startIndicator(_ indicator:UIActivityIndicatorView, vc:UIViewController) {
            indicator.startAnimating()
            indicator.isHidden = false
    
    }
   public static func stopIndicator(_ indicator:UIActivityIndicatorView, vc:UIViewController) {
